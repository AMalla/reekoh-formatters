module.exports = function (rawData) {
	try {
		...
		_.extend(data, {
			...
			count_number: parsedData[5],
			ack: '+SACK:'.concat(parsedData[5]).concat('$')
		});
		...
		if (command[1] === 'GTTOW' || command[1] === 'GTDIS' || command[1] === 'GTIOB' ||
			...
			_.extend(data, {
				...
				mult_analog_vcc1: parsedData[21],
				mult_analog_vcc2: parsedData[22],
				mult_analog_vcc3: parsedData[23],
				digital_in: parsedData[24],
				digital_out: parsedData[25],
				reserved2: parsedData[26],
				reserved3: parsedData[27]
			});
		} else if (command[1] === 'GTERI') {
			_.extend(data, {
				eri_mask: parsedData[4],
				analog_input_vcc: parsedData[5],
				...
				mult_analog_vcc1: parsedData[22],
				mult_analog_vcc2: parsedData[23],
				mult_analog_vcc3: parsedData[24],
				digital_in: parsedData[25],
				digital_out: parsedData[26]
			});

			/*
			 * NOTE: Device Type Optional fields are not
			...
			_.extend(data, {
				...
				mileage: parsedData[20],
				hr_m_cnt: parsedData[21],
				multi_analog_vcc1: parsedData[22],
				multi_analog_vcc2: parsedData[23],
				multi_analog_vcc3: parsedData[24],
				digital_in: parsedData[25],
				digital_out: parsedData[26],
				reserved3: parsedData[27],
				reserved4: parsedData[28],
				reserved5: parsedData[29],
				temp_dev_id: parsedData[30],
				reserved6: parsedData[31],
				temp_dev_data: parsedData[32]
			});
			...
			_.extend(data, {
				...
				multi_analog_vcc1: parsedData[29],
				multi_analog_vcc2: parsedData[30],
				multi_analog_vcc3: parsedData[31],
				digital_in: parsedData[32],
				digital_out: parsedData[33],
				motion_status: parsedData[34],
				ext_pow_vcc: parsedData[35],
				bkp_bat_level: parsedData[36],
				charging: parsedData[37],
				geo_status_mask: parsedData[38],
				reserved5: parsedData[39],
				reserved6: parsedData[40],
				reserved7: parsedData[41]
			});
		}
